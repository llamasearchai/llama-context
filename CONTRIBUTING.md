# Contributing to Llama Context

Thank you for your interest in contributing to Llama Context! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Context:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-context.git
   cd llama-context
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-context.git
   ```
...
By contributing to Llama Context, you agree that your contributions will be licensed under the project's MIT License.
